...
export const AMENITIES_LIST: Amenity[] = [
  ...
  { id: 'pool-view', name: 'Pool view', icon: 'waves-ladder', category: 'scenic_views' },
  { id: 'sea-view', name: 'Sea view', icon: 'waves', category: 'scenic_views' },

  // Bathroom
  { id: 'hot-water', name: 'Hot water', icon: 'bath', category: 'bathroom' },
  { id: 'shower-gel', name: 'Shower gel', icon: 'soap-dispenser-droplet', category: 'bathroom' },
  { id: 'hair-dryer', name: 'Hair dryer', icon: 'wind', category: 'bathroom' },
  { id: 'shampoo', name: 'Shampoo', icon: 'soap-dispenser-droplet', category: 'bathroom' },
  { id: 'conditioner', name: 'Conditioner', icon: 'soap-dispenser-droplet', category: 'bathroom' },
  { id: 'body-soap', name: 'Body soap', icon: 'soap-dispenser-droplet', category: 'bathroom' },
  ...
  { id: 'bed-linen', name: 'Bed linen', icon: 'bed-double', category: 'bedroom_laundry' },
  { id: 'cotton-linen', name: 'Cotton linen', icon: 'bed-double', category: 'bedroom_laundry' },
  ...
  { id: 'iron', name: 'Iron', icon: 'shirt', category: 'bedroom_laundry' },
  { id: 'clothes-storage', name: 'Clothes storage', icon: 'archive', category: 'bedroom_laundry' },

  // Entertainment
  { id: 'tv', name: 'TV', icon: 'tv', category: 'entertainment', description: 'TV with standard cable/satellite' },
  { id: 'games-console', name: 'Games console', icon: 'gamepad-2', category: 'entertainment' },
  { id: 'pool-table', name: 'Pool table', icon: 'circle-dot', category: 'entertainment' },
  { id: 'books', name: 'Books and reading material', icon: 'book-open', category: 'entertainment' },
  { id: 'ping-pong', name: 'Ping pong table', icon: 'volleyball', category: 'entertainment' },
  { id: 'mini-golf', name: 'Mini golf', icon: 'flag', category: 'entertainment' },
  { id: 'exercise-equipment', name: 'Exercise equipment', icon: 'dumbbell', category: 'entertainment' },
  { id: 'life-size-games', name: 'Life-size games', icon: 'dice-5', category: 'entertainment' },
  ...
  { id: 'indoor-fireplace', name: 'Indoor fireplace', icon: 'flame-kindling', category: 'heating_cooling' },
  { id: 'ceiling-fan', name: 'Ceiling fan', icon: 'fan', category: 'heating_cooling' },

  // Home safety
  { id: 'smoke-alarm', name: 'Smoke alarm', icon: 'alarm-smoke', category: 'home_safety' },
  { id: 'carbon-monoxide-alarm', name: 'Carbon monoxide alarm', icon: 'triangle-alert', category: 'home_safety' },
  { id: 'fire-extinguisher', name: 'Fire extinguisher', icon: 'shield-alert', category: 'home_safety' },
  ...
  { id: 'dedicated-workspace', name: 'Dedicated workspace', icon: 'lamp-desk', category: 'internet_office', description: 'In a room with a door' },
  ...
  { id: 'dishwasher', name: 'Dishwasher', icon: 'bubbles', category: 'kitchen_dining' },
  ...
  { id: 'wine-glasses', name: 'Wine glasses', icon: 'wine', category: 'kitchen_dining' },
  { id: 'dining-table', name: 'Dining table', icon: 'table', category: 'kitchen_dining' },
  { id: 'kettle', name: 'Kettle', icon: 'flask-round', category: 'kitchen_dining' },
  { id: 'toaster', name: 'Toaster', icon: 'sandwich', category: 'kitchen_dining' },
  { id: 'baking-sheet', name: 'Baking sheet', icon: 'cooking-pot', category: 'kitchen_dining' },
  { id: 'blender', name: 'Blender', icon: 'blend', category: 'kitchen_dining' },
  ...
  { id: 'launderette-nearby', name: 'Launderette nearby', icon: 'washing-machine', category: 'location_features' },

  // Outdoor
  { id: 'patio-balcony', name: 'Patio or balcony', icon: 'tent-tree', category: 'outdoor' },
  { id: 'outdoor-furniture', name: 'Outdoor furniture', icon: 'armchair', category: 'outdoor' },
  { id: 'bbq-grill', name: 'BBQ grill', icon: 'flame', category: 'outdoor' },
  { id: 'firepit', name: 'Firepit', icon: 'flame-kindling', category: 'outdoor' },
  { id: 'hammock', name: 'Hammock', icon: 'armchair', category: 'outdoor' },
  ...
  { id: 'private-back-garden', name: 'Private back garden', icon: 'fence', category: 'outdoor', description: 'Fully fenced' },
  { id: 'boat-berth', name: 'Boat berth', icon: 'anchor', category: 'outdoor' },
  { id: 'sun-loungers', name: 'Sun loungers', icon: 'sun', category: 'outdoor' },
  { id: 'bikes', name: 'Bikes', icon: 'bike', category: 'outdoor' },
  { id: 'kayak', name: 'Kayak', icon: 'sailboat', category: 'outdoor' },

  // Parking and facilities
  { id: 'free-parking', name: 'Free parking on premises', icon: 'parking-circle', category: 'parking_facilities' },
  { id: 'pool', name: 'Pool', icon: 'waves-ladder', category: 'parking_facilities' },
  { id: 'hot-tub', name: 'Hot tub', icon: 'bath', category: 'parking_facilities' },
  ...
  { id: 'single-level', name: 'Single level home', icon: 'house', category: 'parking_facilities' },
  ...
  { id: 'keypad', name: 'Keypad', icon: 'keyboard', category: 'services' },
  { id: 'pets-allowed', name: 'Pets allowed', icon: 'paw-print', category: 'services' },
  { id: 'long-term-stays', name: 'Long-term stays allowed', icon: 'house', category: 'services', description: 'Allow stays of 28 days or more' },

  // Family
  { id: 'cot', name: 'Cot', icon: 'bed', category: 'family', description: 'Available upon request' },
  { id: 'playpen', name: 'Playpen/travel cot', icon: 'fence', category: 'family', description: 'Available upon request' },
  { id: 'high-chair', name: 'High chair', icon: 'armchair', category: 'family', description: 'With food tray' },
];
